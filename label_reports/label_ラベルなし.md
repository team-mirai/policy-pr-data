...
**【本提案の概要】**
本提案は、匿名ユーザーから寄せられた現状の課題認識に基づき、「２．子育て」マニフェスト内「３）全国版保育マッチングプラットフォームを構築します」の「現状認識・課題分析」部分を更新するものです。**当初の病児保育全般の課題に加え、今回は特に保育園における発熱時の呼び出し基準に関する具体的な問題提起を追記しました。**

**【具体的な変更点】**
前回の変更に加え、以下の内容を「現状認識・課題分析」に追記しました。
「特に、発熱時の呼び出し基準が一律37.5度とされている場合が多く、実際には子どもが元気に遊んでいるケースでも仕事を中断せざるを得ない状況があります。基準を例えば38度まで引き上げるなど、より柔軟な対応を求める声があります。」

**【提案の意図・目的】**
この変更の主な目的は、子育て中の保護者が直面する具体的な困難の一つである「病児保育」の問題、**さらに踏み込んで「保育園からの安易な呼び出し」という課題**をマニフェストに明確に位置づけることです。
...
**特に、発熱基準の画一的な運用は、子どもの状態を個別具体的に見ることなく保護者に負担を強いる場合があり、この現状に対する問題意識を明記しました。**
...
**匿名ユーザーからは、「保育園の発熱の定義が37.5度であるが、大概の場合迎えに行っても元気に遊んでいる。38度まで引き上げて保育園で預かっていて欲しい。頻繁に呼び出しされては仕事にならない」という切実な声が寄せられました。**
民間のベビーシッターサービスも存在しますが、費用面や手配の煩雑さ、信頼できるシッターを見つけることの難しさなどから、誰もが容易に利用できる状況にはありません。公的なサポートや、既存の保育施設の機能を拡充する必要性、**そして何よりも保育現場における子どもの状態に応じた柔軟な判断基準の導入**について、広く議論を喚起したいという思いがあります。
保育園からの呼び出しが頻繁に発生すると、保護者は仕事を中断せざるを得ず、キャリア形成にも影響が出かねません。こうした状況は、少子化対策や女性の社会進出を推進する上でも看過できない障害となっています。
