...
| #1911 | [マニフェスト改善提案：行政・財政の透明化とデータの視覚的提供に関する項目追加](https://github.com/team-mirai/policy/pull/1911) | idobata-policy-app[bot] | open | 2025-06-02 | 2025-06-02 |
...
### #1911: マニフェスト改善提案：行政・財政の透明化とデータの視覚的提供に関する項目追加

#### 説明

匿名ユーザーさんからの提案に基づき、マニフェストの目次に「行政・財政の透明化とデータの視覚的提供」という項目を追加しました。

**変更内容：**

* 「ステップ１『デジタル時代の当たり前をやりきる』」のセクションの目次に、「８．行政・財政の透明化とデータの視覚的提供」を新たに追加しました。

**提案の意図・目的：**

この変更は、税金や社会保障費といった公金の流れを、国民がより直感的に理解できるようにすることを目的としています。現状では、これらの情報が複雑な書類やデータに分散しており、一般の国民が全体像を把握することは困難です。

提案された「行政・財政の透明化とデータの視覚的提供」では、具体的に以下のような取り組みを目指します。

*   **データの視覚化:** 税金（消費税、復興税、森林環境税など特定の目的を持つ税を含む）や年金、その他の社会保障費が、どこから集められ、どのように配分され、最終的に何に使われているのかを、フローチャートやデータグラフィックスのような視覚的なインターフェースを通じてリアルタイムに近い形で表示します。
*   **情報の集約とアクセス容易化:** 国民が必要な情報に容易にアクセスできるよう、関連情報を一元的に集約し、分かりやすい形で提供します。これにより、大量の専門的な書類を読み解く必要なく、誰でも財政状況を理解できるようになります。
*   **お金の「色」の明確化:** 特定の目的のために徴収された税金が、実際にその目的のために使われているのかを追跡しやすくします。また、例えば受け取られなかった年金がどこへ行くのかなど、これまで不透明だった部分についても情報を開示します。
*   **継続的な情報開示とアーカイブ:** 表示されるデータは継続的に更新され、過去のデータもアーカイブとして参照できるようにします。これにより、政策決定の経緯や効果検証を長期的に行うことが可能になります。

**背景：**

この提案は、「税金や社会保障のお金の流れが不透明であり、もっと分かりやすく見える化してほしい」という匿名ユーザーさんの問題提起から生まれました。現在の情報公開のあり方では、国民が国の財政状況を正確に理解し、建設的な議論に参加することが難しいという課題認識があります。

この新しい項目を通じて、国民の知る権利を保障し、行政・財政運営への信頼を高めることを目指します。また、データに基づいた政策議論を活発化させ、より良い民主主義の実現に貢献したいと考えています。

この変更にご意見があれば、ぜひお寄せください。
