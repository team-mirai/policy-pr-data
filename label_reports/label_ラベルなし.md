...
| #2350 | [医療：マイナンバーカードによる問診票情報共有の推進](https://github.com/team-mirai/policy/pull/2350) | idobata-policy-app[bot] | open | 2025-06-14 | 2025-06-14 |
...
### #2350: 医療：マイナンバーカードによる問診票情報共有の推進

#### 説明

阿井上夫さんの提案に基づき、医療政策の改善案を提案します。

## 変更点

「医療」分野の「STEP1 デジタル時代の当たり前をやり切る」にある項目「スマート受付とキャッシュレスで待ち時間のない受診を実現」の記述を以下のように更新しました。

**変更前:**
[スマート受付とキャッシュレスで待ち時間のない受診を実現](https://github.com/team-mirai/policy/blob/main/17_ステップ１医療.md#2スマート受付とキャッシュレスで待ち時間のない受診を実現)

**変更後:**
[スマート受付とキャッシュレスで待ち時間のない受診を実現。マイナンバーカードによる問診票情報の共有（系列薬局から全国規模へ）も推進します](https://github.com/team-mirai/policy/blob/main/17_ステップ１医療.md#2スマート受付とキャッシュレスで待ち時間のない受診を実現)

## 変更の意図と目的

現状、マイナンバーカードを保険証として利用している場合でも、薬局を訪れるたびに問診票の記入を求められることがあります。これは利用者にとって手間であり、デジタル化の恩恵を十分に受けられていない状況です。

この変更の主な目的は、マイナンバーカードを活用することで、薬局での問診票記入の負担を軽減し、利用者の利便性を向上させることです。

## 背景

阿井上夫さんから、「マイナ保険証を使っているのに薬局でいちいち問診票を書かなきゃいけないのをなんとかして欲しい」という具体的な問題提起がありました。特に、「最低でも系列店では問診票の内容を共有できるようにして欲しい。理想を言えばマイナンバーカードで共有出来るようにして欲しい」というご意見をいただきました。

この提案は、利用者の実体験に基づいたものであり、多くの人が共感できる課題であると考えられます。

段階的な導入を想定しており、まずは系列薬局間での情報共有を実現し、将来的には全国の薬局でマイナンバーカードを介した問診票情報の共有を目指します。これにより、患者さんはどの薬局を利用しても、過去の情報を再入力する手間なく、スムーズにサービスを受けられるようになります。

この改善により、医療現場の効率化にも繋がり、薬剤師がより専門的な業務に集中できる環境づくりにも貢献できると期待されます。
