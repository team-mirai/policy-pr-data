...
| #2104 | [README: 構文形式「理念動因構造©」導入による政策記述方式の明確化提案](https://github.com/team-mirai/policy/pull/2104) | idobata-policy-app[bot] | open | 2025-06-10 | 2025-06-10 |
...
| #2107 | [マニフェスト目次に「高齢者支援」の項目追加提案（鈴木誠子さん提案）](https://github.com/team-mirai/policy/pull/2107) | idobata-policy-app[bot] | open | 2025-06-10 | 2025-06-10 |
| #2108 | [【新規政策提案】パブリックホーム構想：年間10万人の新たな命を育む](https://github.com/team-mirai/policy/pull/2108) | idobata-policy-app[bot] | open | 2025-06-10 | 2025-06-10 |
...
| #2122 | [教育政策の自由度向上に関する懸念点の追記（水田様ご提案）](https://github.com/team-mirai/policy/pull/2122) | idobata-policy-app[bot] | open | 2025-06-10 | 2025-06-10 |
| #2123 | [とまとさん提案：教育における個別最適化と能動的学習の促進](https://github.com/team-mirai/policy/pull/2123) | idobata-policy-app[bot] | open | 2025-06-10 | 2025-06-10 |
| #2124 | [README.mdの改善提案：サポート校の費用負担問題に関する記述追加](https://github.com/team-mirai/policy/pull/2124) | idobata-policy-app[bot] | open | 2025-06-10 | 2025-06-10 |
...
| #2126 | [目次のステップ3における項目順を修正](https://github.com/team-mirai/policy/pull/2126) | idobata-policy-app[bot] | open | 2025-06-10 | 2025-06-10 |
...
### #2100: AI戦略を支える半導体基盤の強化に関する提案

#### 説明

多見谷修平です。この度は、政策案「４．産業」に関し、日本のAI戦略をより強固なものにするための重要な視点として、半導体基盤の強化を提案させていただきます。

現状の政策案では、AIの活用による産業改革が主軸として明確に示されており、その方向性には大いに賛同いたします。しかしながら、AIの高度な処理能力を最大限に引き出し、持続的な進化を担保するためには、その頭脳であり心臓部とも言える高性能な半導体（CPU、HBMなど）及び関連製品の安定確保と、国内における製造・技術開発能力の向上が不可欠です。この点が現在の政策案では十分にカバーされていないと考え、具体的な政策として追加することを提案いたします。

主な変更点として、「４．産業」の章に新たに「３） AI戦略を支える半導体基盤の強化」という項目を設けました。その中で、まず「現状認識・課題分析」として、AIの進化と普及における高性能半導体の不可欠性、これらの半導体の安定供給、国内における生産能力の向上、関連技術の継続的な進化が我が国のAI戦略成功の鍵であること、そして、半導体製造装置メーカーや素材メーカー、半導体メーカーの多くが地方に立地していることによる人材確保の課題を明記しました。

これらを踏まえた「政策概要」としては、以下の具体的な施策を盛り込んでいます。
1.  海外の大手半導体メーカー（TSMCなど）の誘致を積極的に推進し、国内への投資を促進することで、先端技術へのアクセスと国内製造能力の向上を目指します。
2.  Rapidus（ラピダス）のような国内の次世代半導体メーカーの育成を強力に支援し、国内における先端半導体の製造基盤を確立し、技術的自立性を高めます。
3.  我が国が国際的に強みを持つ半導体製造装置や関連素材の分野における国際競争力を一層強化し、グローバル市場でのリーダーシップを維持・拡大します。
4.  半導体のサプライチェーン強靭化のため、可能な限り国内での研究開発から製造、供給までを一貫して行える体制の構築を目指し、経済安全保障上のリスク低減を図ります。
5.  地方に立地する半導体関連工場や事業所における人材不足の解消を支援します。その一環として、リモートワーク環境の整備を推進するとともに、遠隔での生産ライン監視や、緊急時の遠隔操作による一部対処を可能とするシステムの開発及び導入を支援します。これにより、地理的な制約を超えた人材活用と生産性の向上を図り、地方創生にも貢献します。

この提案の意図は、AI戦略を絵に描いた餅に終わらせず、実質的な成果に結びつけるための物理的・技術的基盤を確立することにあります。半導体技術はAIのみならず、今後のあらゆる産業の競争力を左右する戦略的基盤技術です。その安定確保と国内での開発生産能力の強化は、経済安全保障の観点からも極めて重要であり、国家戦略として取り組むべき喫緊の課題と言えます。また、地方の雇用創出と活性化に貢献する視点も盛り込むことで、より包摂的な成長を目指します。

この改善により、日本のAI戦略がより実効性のあるものとなり、国際競争力の強化、経済成長の促進、そして国民生活の質の向上に繋がることを期待しています。
...
### #2119: 将来技術のリスクを考慮し、物理媒体も含む多層的データ保護戦略を情報セキュリティ基盤強化策に追加

#### 説明

山河　源一郎（ヤマカワ　ゲンイチロウ）です。

現在検討中の政策案「５．科学技術」に関し、特に「１）研究支援業務へのAI・IT導入を支援します」で触れられている情報セキュリティの強化策について、将来の技術的進展とそのリスクをより深く考慮した内容とするための改善提案です。

**提案の背景と目的：**

AI技術は日々急速な進化を遂げており、その恩恵は計り知れませんが、同時に新たなリスクも生み出しています。特に、AIが自律的に行動し、悪意を持った第三者による不正アクセスやサイバー攻撃に利用される可能性、あるいはシステムの脆弱性を突いて広範囲なパスワード解析を行うといったシナリオは、深刻な脅威です。

さらに、量子コンピュータや光電融合技術といった将来の破壊的技術が実用化された場合、現在の暗号システムやセキュリティ対策が無効化される可能性も指摘されています。ブロックチェーン技術のような先進的な対策も、これらの革新的技術の前では限界を迎えるかもしれません。

このような将来起こりうる脅威から、国の重要な研究データや基幹システムを確実に保護するためには、現行の対策に加えて、より長期的かつ多角的な視点に立った情報セキュリティ基盤の強化が不可欠です。

本提案の目的は、これらの潜在的なリスクを政策案に明記し、それらに対抗するための研究開発と人材育成を促進することです。また、単に最新技術を追い求めるだけでなく、例えば物理的に隔離された磁気記録媒体（HDDなど）といった、特定の攻撃に対しては有効性を持ちうる「枯れた技術」の活用も視野に入れた、多層的で重層的なデータ保護戦略の検討を促すことにあります。これにより、いかなる状況下でも国家の知的財産と情報インフラを守り抜く強靭な体制の構築を目指します。

**具体的な変更点：**

「１）研究支援業務へのAI・IT導入を支援します」の「政策概要」の項目に、以下の記述を追加しました。

「AIの急速な進化や、量子コンピュータ、光電融合技術といった将来の破壊的技術の出現も視野に入れ、ブロックチェーン等の現行セキュリティ技術の限界も踏まえた上で、長期的な視点での情報セキュリティ基盤の強化と、それに関する研究開発及び人材育成を推進します。その際、最新技術だけでなく、特定の攻撃に対して耐性を持つ可能性のある物理的な記録媒体の活用を含めた、多層的なデータ保護戦略の検討も重要です。」

**期待される効果：**

この変更により、以下の効果が期待されます。

1.  **政策の先進性と実効性の向上：** 将来の予期せぬ脅威に対する備えを明記することで、政策案がより長期的視点を持ち、実効性の高いものとなります。
2.  **情報セキュリティ基盤の強靭化：** 多様な脅威に対応できる多層的な保護戦略を推進することで、国の情報セキュリティ基盤の安定性と信頼性が飛躍的に向上します。
3.  **研究開発環境の安全性向上：** 研究者がサイバー攻撃等のリスクに怯えることなく、安心して研究開発に専念できるセキュアな環境の整備に貢献します。
4.  **技術開発の促進：** 将来リスクに対応するための新たなセキュリティ技術や、既存技術の応用研究（例：物理媒体の再評価と活用）を促進するきっかけとなります。

この提案が、我が国の科学技術の発展と安全保障に貢献できることを確信しています。ご検討のほど、よろしくお願いいたします。
