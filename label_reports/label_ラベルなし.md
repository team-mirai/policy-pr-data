...
音声AI一次問い合わせ窓口におけるカスタマーハラスメント（カスハラ）対策の強化
PCログ等を活用した勤務状況の可視化と適正化支援システムの導入
公正で納得感のある人事評価制度の実現に向けた見直し
変更内容と提案の意図・目的、背景:

1. 音声AI一次問い合わせ窓口におけるカスハラ対策の強化

課題認識: 行政窓口への過度なクレームや不当要求（カスハラ）は、職員の精神的負担増大、行政サービス全体の質の低下を招く深刻な問題です。
変更点: 「音声AIによる一次問い合わせ窓口」の項目に以下を追記。
また、問い合わせ対応開始時に、サービス向上のため対応内容をデータ保存することを通告したうえで録音を行います。一次対応の段階で問い合わせ内容の性質をAIが分類し、悪質なクレームと判断される場合には警察への通報を示唆するなど、職員を保護し、対応方針の決定を補助する機能を付与します。
意図・目的:
録音と事前通告によるカスハラ抑止。
AIによる内容分析と対応方針補助による職員保護と適切な組織対応の促進。
職員の精神的負担軽減と、質の高い市民サービスの提供。
背景: AI技術を業務効率化だけでなく、職員の労働環境改善にも活用すべきという考えに基づきます。takechan様からの問題提起を受け、職員が安心して業務に取り組める環境整備を目指します。
2. 勤務状況の可視化と適正化支援システムの導入

課題認識: 一部の職務に無関係な離席など、いわゆる「怠業」の可能性は、行政組織の信頼性や効率性を損なう可能性があります。内部通報だけでなく、システマティックな対策が求められます。
変更点: 「行政内部DX」に以下を新設。
勤務状況の可視化と適正化支援 PCログ等を活用し、客観的なデータに基づいた勤務状況の把握を支援するシステムを導入します。これにより、不要な長時間離席の抑止や、業務実態に即した人員配置・業務分担の見直しを促し、効率的で公平な働き方を推進します。システム運用にあたっては、職員のプライバシーに配慮し、あくまで業務改善やサポートを目的とすることを明確にします。また、緊急時等、やむを得ない離席については、事後報告や上長承認による柔軟な運用を可能とします。
意図・目的:
PCログ等の客観的データに基づく勤務状況の把握。
不要な長時間離席の抑止と、業務実態に即した人員配置・業務分担の見直し促進。
プライバシーに配慮しつつ、業務改善を目的とした効率的で公平な働き方の推進。
単なる監視ではなく、業務効率化や適正な人員配置のためのデータ活用を意図。
...
課題認識: 現行の人事評価制度では、目標を大幅に上回る成果や前例のない挑戦が正当に評価されにくく、職員のモチベーション低下を招くケースがあります。特に、前例がないことを理由に高い評価が得られない、直属上司の評価が最終評価に反映されにくいといった問題が指摘されています。
変更点: 「政策概要」に以下を新設。
公正で納得感のある人事評価制度の実現 職員のモチベーション向上のため、人事評価制度を見直し、現場の貢献が正当に評価される仕組みを構築します。直属の上司による評価を最大限尊重するとともに、前例のないチャレンジや顕著な成果については、外部の有識者も交えた客観的な評価プロセスを導入し、職員が意欲を持って職務に取り組める環境を整備します。
意図・目的:
職員のモチベーション向上を最優先とし、現場の貢献が正当に評価される仕組みの構築。
直属上司の評価を最大限尊重し、評価の納得感を高める。
前例のない成果や挑戦に対し、外部評価者も交えた客観的評価プロセスを導入することで、公平性を担保する。
職員が失敗を恐れずに新しい挑戦を奨励する文化の醸成。
背景: takechan様ご自身の経験を踏まえ、公務員のモチベーション向上のためには人事評価制度の見直しが不可欠であるとの強い問題提起がありました。「前例主義」や「横並び意識」が評価の足かせとなる現状を改め、高い志を持って業務に取り組む職員が報われる制度を目指します。
これらの変更は、AIやIT技術を活用しつつ、公務員の働きがいを高め、最終的には国民への行政サービスの質向上に繋がるものと確信しています。皆様からのご意見をいただき、さらに良い政策へと磨き上げていきたいと考えております。
