...
| #1841 | [経済財政方針に「総報酬」の明確化と納得感向上の項目を追加](https://github.com/team-mirai/policy/pull/1841) | idobata-policy-app[bot] | open | 2025-05-31 | 2025-05-31 |
...
### #1841: 経済財政方針に「総報酬」の明確化と納得感向上の項目を追加

#### 説明

匿名ユーザー様からのご提案に基づき、マニフェストファイルを更新しました。
今回の更新は、前回（README.mdの目次変更）の内容をさらに具体化し、詳細な政策案を追記するものです。

**変更の背景:**
現行の社会保険制度において、特に企業が負担する社会保険料について、労働者からはその内容が見えにくく、実質的な負担感や手取り額への不満に繋がっているのではないか、という問題意識が匿名ユーザー様より示されました。企業が労働者のために支出しているコストが、労働者自身に十分に認識されていない現状があるとのご指摘です。

**前回の変更内容（README.md）:**
上記の問題意識を踏まえ、マニフェストの目次である「README.md」ファイルの「ステップ２『変化に対応できる、しなやかな仕組みづくり』」の中の「３．経済財政」の項目に、新たな方針として以下を追記しました。
*   （経済財政の方針）「総報酬」の明確化とコミュニケーションによる納得感の向上

**今回の追加変更内容（23_ステップ２経済財政.md の新規作成と内容記述）:**
そして今回、上記の方針を具現化する非常に詳細かつ具体的な政策案として、匿名ユーザー様より「**対話型・実感志向のトータルリワード戦略**」をご提案いただきました。この素晴らしい戦略の全文を、「23_ステップ２経済財政.md」というファイルに新たに記述し、保存いたしました。

この「対話型・実感志向のトータルリワード戦略」の骨子は以下の通りです。
単なる情報開示に留まらず、「個別化された情報提供」「双方向のコミュニケーション」「具体的な恩恵の実感」を重視し、従業員が企業負担分を含む自身の総報酬を「自分ごと」として捉え、その価値を真に理解・納得できる状態を目指すものです。
具体的な施策として、以下のような多岐にわたる提案が含まれています。
1.  **パーソナライズされた「わたしのトータルリワード」見える化ツールの導入・進化**: 企業負担社会保険料の具体的な内訳や、それが将来の年金受給額や医療費自己負担軽減にどう繋がるかのシミュレーション、AIチャットボットによる個別質問応答などを盛り込んだオンラインツール。
2.  **「社会保険とキャリア・ライフプラン」をテーマとした対話型ワークショップの定期開催**: 人事担当者や外部専門家を交え、少人数での双方向コミュニケーションを通じて理解を深め、疑問や不安を解消する場。
3.  **国（公的機関）提供情報との連携と「説明責任の分担」の明確化**: 企業は自社の負担額や具体的な恩恵について、国は制度全体の意義や法的根拠について、それぞれ分かりやすく説明する責任を分担し連携する。
4.  **「見えない貢献」を「実感できる価値」へ転換する工夫**: 健康経営との連動（健康増進へのインセンティブ付与など）や、魅力的な福利厚生（選択型カフェテリアプランなど）を通じて、企業からの貢献を実感しやすくする。
5.  **継続的な改善とフィードバックループの確立**: 従業員満足度調査などで効果を測定し、従業員からの声を元に情報提供の内容や方法を継続的に改善する。

**変更全体の意図と目的:**
これらの変更の主な目的は、まず労働者に支払われる報酬全体の構成を「見える化」し、企業が負担している社会保険料などが労働者のためにどのような形で具体的に役立っているのかを丁寧に説明し、双方向のコミュニケーションを改善することで、自身の処遇や社会保障制度に対する労働者の納得感を高めることです。
「見えない形にされている」という不満を軽減し、より建設的な労使関係の構築に寄与することを目指します。

**期待される効果:**
この包括的な戦略が実行されることにより、労働者は自身が企業から受けている経済的価値の全体像をより明確に、かつ具体的に「自分ごと」として把握できるようになります。それにより、現在の処遇への納得感向上、社会保障制度への深い理解、そして企業への信頼感の醸成が期待されます。
企業側にとっても、従業員のエンゲージメント向上、人材の採用・定着における魅力向上、そして「隠れたコスト」ではなく「従業員への価値ある投資」として企業負担分を再定義できるといったメリットが見込まれます。

この変更が、より多くの働く人々にとって納得感のある社会保険制度のあり方を考えるきっかけとなり、チームみらいのマニフェストをより良いものにしていくための一助となることを願っています。
（提案者：匿名ユーザー）
